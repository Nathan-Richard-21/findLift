...
const CameraCapture = ({ onCapture, onClose, type = 'selfie' }) => {
  ...
  const typeInstructions = {
    selfie: 'Position your face in the frame and wait for automatic capture',
    document: 'Position the document clearly in the frame and wait for automatic capture'
  };
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <div>
            <h3 className="text-lg font-semibold capitalize">
              {type === 'selfie' ? 'Take Selfie' : 'Capture Document'}
            </h3>
            <p className="text-sm text-gray-600">
              Position clearly and wait for automatic capture
            </p>
          </div>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-700">
            <FaTimes />
              ...
              <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
                <div className="text-center text-white">
                  {type === 'selfie' ? (
                    ...
                    <FaIdCard className="text-6xl mx-auto mb-4 animate-pulse" />
                  )}
              ...
              <div className="text-sm text-blue-700 space-y-1">
                ...
                {type === 'selfie' ? (
                  ...
                  <>
                    ...
                    <p>• Ensure all corners are visible</p>
